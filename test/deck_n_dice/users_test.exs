defmodule DeckNDice.UsersTest do
  use DeckNDice.DataCase
  ...
  describe "users" do
    ...
    test "create_user/1 with valid data creates a user" do
      valid_attrs = %{full_name: "some full_name", gender: "some gender", biography: "some biography", email: "some email", dob: ~D[2024-03-14]}
    ...
    test "update_user/2 with valid data updates the user" do
      user = user_fixture()
      update_attrs = %{full_name: "some updated full_name", gender: "some updated gender", biography: "some updated biography", email: "some updated email", dob: ~D[2024-03-15]}
